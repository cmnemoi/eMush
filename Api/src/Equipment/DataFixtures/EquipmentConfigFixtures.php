...
class EquipmentConfigFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        /** @var Action $changeDaedalusOrientationAction */
        $changeDaedalusOrientationAction = $this->getReference(ActionsFixtures::CHANGE_DAEDALUS_ORIENTATION);
        ...
        $commandTerminal
            ...
            ->setIsFireBreakable(false)
            ->setIsBreakable(true)
            ->setActions([$repair12, $sabotage12, $reportAction, $examineAction, $hackAction, $changeDaedalusOrientationAction])
            ->buildName(GameConfigEnum::DEFAULT)
        ;
        ...
        $gravitySimulator
            ...
            ->setMechanics([$gravitySimulatorGear])
            ->setIsFireDestroyable(false)
            ->setIsFireBreakable(false)
            ->setIsBreakable(true)
            ->setActions([$repair6, $sabotage6, $reportAction, $examineAction])
