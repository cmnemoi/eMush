...
abstract class AchievementConfigData
{
    ...
    public static function getAll(): array
    {
        return [
            ...
            new AchievementConfigDto(
                name: AchievementEnum::HAS_MUSHED_1,
                points: 1,
                threshold: 1,
            ),
            new AchievementConfigDto(
            ...
            new AchievementConfigDto(name: AchievementEnum::PROJECT_COMPLETE_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::RESEARCH_COMPLETE_1, points: 1, threshold: 1),
            ...
            new AchievementConfigDto(name: AchievementEnum::NILS_CONTACTED_1, points: 1, threshold: 1),
            new AchievementConfigDto(
            ...
            new AchievementConfigDto(name: AchievementEnum::TEAM_REBELS_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::TEAM_REBELS_3, points: 1, threshold: 3),
            new AchievementConfigDto(name: AchievementEnum::TEAM_REBELS_6, points: 1, threshold: 6),
            ...
            new AchievementConfigDto(name: AchievementEnum::SHRINKER_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::SHRINKER_10, points: 1, threshold: 10),
            new AchievementConfigDto(name: AchievementEnum::SHRINKER_50, points: 1, threshold: 50),
            new AchievementConfigDto(name: AchievementEnum::PHYSICIAN_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::PHYSICIAN_10, points: 1, threshold: 10),
            new AchievementConfigDto(name: AchievementEnum::PHYSICIAN_50, points: 1, threshold: 50),
            ...
            new AchievementConfigDto(name: AchievementEnum::PROJECT_TEAM_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::PROJECT_TEAM_2, points: 2, threshold: 2),
            new AchievementConfigDto(name: AchievementEnum::PROJECT_TEAM_4, points: 5, threshold: 4),
            new AchievementConfigDto(name: AchievementEnum::PROJECT_TEAM_8, points: 10, threshold: 8),
            new AchievementConfigDto(name: AchievementEnum::PROJECT_TEAM_16, points: 5, threshold: 16),
            new AchievementConfigDto(name: AchievementEnum::RESEARCH_TEAM_1, points: 1, threshold: 1),
            new AchievementConfigDto(name: AchievementEnum::RESEARCH_TEAM_2, points: 2, threshold: 2),
            ...
            new AchievementConfigDto(name: AchievementEnum::EDEN_BIODIVERSITY_1, points: 1, threshold: 1),
