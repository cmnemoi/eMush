    ...
    private function shouldNormalizeDiseaseDataProvider(): array
    {
        return [
            ...
            'agoraphobia' => [
                ...
                'diseaseDescription' => 'Vous êtes effrayé par la foule et les grands espaces, vous avez, en plus, des vertiges incontrôlables... Dans l\'espace, ça ne va pas le faire.//S\'il y a au moins **4** personnes dans la pièce, chaque action coûte **1** :pa: de plus.//S\'il y a au moins **4** personnes dans la pièce, chaque déplacement coûte **1** :pm: de plus.//Impossible de **piloter**.',
            ],
            'gastroenteritis' => [
