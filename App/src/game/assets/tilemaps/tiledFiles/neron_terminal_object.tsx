...
<tileset version="1.5" tiledversion="1.7.2" name="neron_terminal_object" tilewidth="41" tileheight="64" tilecount="16" columns="8" objectalignment="bottomleft">
 <image source="../neron_terminal_object.png" width="328" height="128"/>
 <tile id="0">
  <animation>
