...
class ActionSubscriberCest
{
    ...
    public function testPlayerDropTalkie(FunctionalTester $I)
    {
        ...
        $actionEvent = new ActionEvent($dropAction, $iTrackie, $player, $dropAction->getActionTags(), $iTrackie);
    ...
    public function testPlayerMoveWithTrackie(FunctionalTester $I)
    {
        ...
        $actionEvent = new ActionEvent($moveAction, $player, $player, $moveAction->getActionTags());
    ...
    public function testPlayerMoveWithoutTrackie(FunctionalTester $I)
    {
        ...
        $actionEvent = new ActionEvent($moveAction, $player, $player, $moveAction->getActionTags(), null);
