...
export class migration1601574699180 implements MigrationInterface {
    name = 'migration1601574699180'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `room` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `statuses` text NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `daedalusId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `player` (`id` int NOT NULL AUTO_INCREMENT, `user` varchar(255) NOT NULL, `character` varchar(255) NOT NULL, `skills` text NOT NULL, `items` text NOT NULL, `statuses` text NOT NULL, `healthPoint` int NOT NULL, `moralPoint` int NOT NULL, `actionPoint` int NOT NULL, `movementPoint` int NOT NULL, `satiety` int NOT NULL, `isMush` tinyint NOT NULL, `isDirty` tinyint NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `daedalusId` int NULL, `roomId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `room_log` (`id` int NOT NULL AUTO_INCREMENT, `roomId` int NOT NULL, `log` varchar(255) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
