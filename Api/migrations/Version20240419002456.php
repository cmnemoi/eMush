 ...
 */
final class Version20240419002456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_config (id INT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, efficiency INT NOT NULL, bonus_skills TEXT NOT NULL, PRIMARY KEY(id))');
