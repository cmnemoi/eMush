...
class ModifierConfigData
{
    public static array $dataArray = [
        ...
        [
            'name' => 'modifier_technician_specialist_point',
            'modifierName' => ModifierNameEnum::TECHNICIAN_SPECIALIST_POINT,
            'targetEvent' => ActionVariableEvent::APPLY_COST,
            'strategy' => ModifierStrategyEnum::VARIABLE_MODIFIER,
            'priority' => ModifierPriorityEnum::OVERRIDE_VALUE_PRIORITY,
            'applyOnTarget' => false,
            ...
            'modifierActivationRequirements' => [],
            'tagConstraints' => [
                ActionTypeEnum::ACTION_REPAIR => ModifierRequirementEnum::ANY_TAGS,
            ],
        ],
        [
