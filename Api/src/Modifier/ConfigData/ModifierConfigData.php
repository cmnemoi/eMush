    ...
    public static function getAll(): array
    {
        return [
            ...
            new VariableEventModifierConfigDto(
                ...
                name: ModifierNameEnum::TRAIL_REDUCER_MODIFIER,
                strategy: ModifierStrategyEnum::VARIABLE_MODIFIER,
            ...
            new VariableEventModifierConfigDto(
                key: 'modifier_for_player_set_100_percentage_critical_for_takeoff_and_land_actions',
                name: null,
                strategy: ModifierStrategyEnum::VARIABLE_MODIFIER,
                modifierRange: 'player',
                modifierActivationRequirements: [],
            ...
            new VariableEventModifierConfigDto(
                key: ModifierNameEnum::DISEASE_SHOOT_ACTION_REDUCED_SUCCESS,
                name: ModifierNameEnum::DISEASE_SHOOT_ACTION_REDUCED_SUCCESS,
                strategy: ModifierStrategyEnum::VARIABLE_MODIFIER,
                modifierRange: 'player',
                modifierActivationRequirements: [],
                targetEvent: ActionVariableEvent::ROLL_ACTION_PERCENTAGE,
            ...
            new VariableEventModifierConfigDto(
                key: ModifierNameEnum::ATTACKS_ON_SELF_X0_5,
                name: ModifierNameEnum::ATTACKS_ON_SELF_X0_5,
                strategy: ModifierStrategyEnum::VARIABLE_MODIFIER,
                modifierRange: ModifierHolderClassEnum::PLAYER,
                modifierActivationRequirements: [],
                targetEvent: ActionVariableEvent::ROLL_ACTION_PERCENTAGE,
            ...
            new DirectModifierConfigDto(
                key: 'direct_modifier_player_-3_max_healthPoint',
                name: null,
                strategy: ModifierStrategyEnum::DIRECT_MODIFIER,
                modifierRange: ModifierHolderClassEnum::PLAYER,
                modifierActivationRequirements: [],
                triggeredEvent: 'change.value.max_player_-3_healthPoint',
                revertOnRemove: true,
                eventActivationRequirements: [],
            ),
            new DirectModifierConfigDto(
                key: 'direct_modifier_player_-5_max_healthPoint',
                name: null,
                strategy: ModifierStrategyEnum::DIRECT_MODIFIER,
                modifierRange: ModifierHolderClassEnum::PLAYER,
                modifierActivationRequirements: [],
                triggeredEvent: 'change.value.max_player_-5_healthPoint',
                revertOnRemove: true,
                eventActivationRequirements: [],
            ),
            ...
            new EventModifierConfigDto(
                key: ModifierNameEnum::PREVENT_METAL_PLATE_0_7,
                name: ModifierNameEnum::PREVENT_METAL_PLATE_0_7,
                strategy: ModifierStrategyEnum::PREVENT_EVENT,
                modifierRange: ModifierHolderClassEnum::PLAYER,
                modifierActivationRequirements: [
                    'random_70',
                ],
                targetEvent: PlayerEvent::METAL_PLATE,
                priority: ModifierPriorityEnum::PREVENT_EVENT,
                applyWhenTargeted: true,
                tagConstraints: [],
            ),
