    ...
    <div class="user_list_container">
        ...
        >
            ...
            <template #row-actions="slotProps">
                <router-link :to="{ name: 'AdminActionCostDetail', params: { actionCostId : slotProps.id } }">{{ $t('admin.edit') }}</router-link>
            </template>
        </Datatable>
    </div>
</template>
...
export default defineComponent({
    ...
    data() {
        return {
            fields: [
                ...
                {
                    key: 'movementPointCost',
                    name: 'movementPointCost',
                    sortable: true
                },
                {
                    key: 'moralPointCost',
    ...
    methods: {
        loadData() {
            ...
            ApiService.get(urlJoin(process.env.VUE_APP_API_URL+'action_costs'), params)
                .then((result) => {
                    return result.data;
                })
