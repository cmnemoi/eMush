...
#[ORM\Entity]
class ModifyDamageWeaponEffectConfig extends AbstractEventConfig implements QuantityWeaponEffectConfig
{
    ...
    public function updateFromDto(ModifyDamageWeaponEffectConfigDto $dto): void
    {
        $this->name = $dto->name;
