...
const AdminActionsService = {
    ...
    deleteSkillForPlayer: async(playerId: integer, skill: string): Promise<any> => {
        return await ApiService.post(urlJoin(API_URL, 'admin/debug/delete-player-skill'), { playerId, skill });
    },
