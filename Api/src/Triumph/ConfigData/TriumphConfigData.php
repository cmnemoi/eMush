...
abstract class TriumphConfigData
{
    ...
    public static function getAll(): array
    {
        return [
            ...
            new TriumphConfigDto(
                key: TriumphEnum::ALIEN_FRIEND_FIGHT_PREVENTED->toConfigKey('default'),
                name: TriumphEnum::ALIEN_FRIEND_FIGHT_PREVENTED,
                targetedEvent: PlanetSectorEvent::PLANET_SECTOR_EVENT,
                tagConstraints: [
                    PlanetSectorEvent::FIGHT => TriumphSourceEventInterface::ALL_TAGS,
                    PlanetSectorEnum::INSECT => TriumphSourceEventInterface::ANY_TAG,
                    PlanetSectorEnum::INTELLIGENT => TriumphSourceEventInterface::ANY_TAG,
                    PlanetSectorEnum::MANKAROG => TriumphSourceEventInterface::ANY_TAG,
                    PlanetSectorEnum::PREDATOR => TriumphSourceEventInterface::ANY_TAG,
                    PlanetSectorEnum::RUMINANT => TriumphSourceEventInterface::ANY_TAG,
                    PlanetSectorEvent::PROVISION => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::ACCIDENT => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::ARTEFACT => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::BACK => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::DISEASE => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::KILL_RANDOM => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::ITEM_LOST => TriumphSourceEventInterface::NONE_TAGS,
                    PlanetSectorEvent::NOTHING_TO_REPORT => TriumphSourceEventInterface::NONE_TAGS,
                ],
                scope: TriumphScope::PERSONAL_JANICE,
                targetSetting: TriumphTarget::ACTIVE_EXPLORERS,
                quantity: 3,
            ...
            new TriumphConfigDto(
                key: TriumphEnum::ALIEN_FRIEND_PROVISION->toConfigKey('default'),
                name: TriumphEnum::ALIEN_FRIEND_PROVISION,
                targetedEvent: PlanetSectorEvent::PLANET_SECTOR_EVENT,
                tagConstraints: [
