...
#[ORM\Entity]
class BreakRandomItemsWeaponEffectConfig extends AbstractEventConfig implements QuantityWeaponEffectConfig
{
    ...
    public function updateFromDto(BreakRandomItemsWeaponEffectConfigDto $dto): void
    {
        $this->name = $dto->name;
