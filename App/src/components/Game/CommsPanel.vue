...
<div class="comms-panel">
  <div class="top-banner">
    <ul class="tabs">
      ...
      <li class="active"><img src="@/assets/images/comms/wall.png"></li>
      <li><img src="@/assets/images/comms/fav.png"></li>
      <li><img src="@/assets/images/comms/mush.png"></li>
  ...
  & .top-banner {
    ...
    & .tabs {
      ...
      & li{
        ...
        &.active { background:  rgba(194, 243, 252, 1); }
      }
    }
  }
