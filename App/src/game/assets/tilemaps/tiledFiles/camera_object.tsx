...
<tileset version="1.5" tiledversion="1.7.2" name="camera_object" tilewidth="25" tileheight="17" tilecount="14" columns="14" objectalignment="bottomleft">
 <img src="../camera_object.png" width="350" height="17"/>
 <tile id="0">
  <animation>
