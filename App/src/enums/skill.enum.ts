...
export const SkillIconRecord: {[index: string]: any} = {
    ...
    [SkillEnum.APPRENTICE]: {
        'icon': getImgUrl('skills/human/apprentice.png')
    },
    ...
    [SkillEnum.BOTANIST]: {
        'icon': getImgUrl('skills/human/botanist.png')
    },

    [SkillEnum.CAFFEINE_JUNKIE]: {
        'icon': getImgUrl('skills/human/caffeine_junkie.png')
    },

    [SkillEnum.CHEF]: {
        'icon': getImgUrl('skills/human/chef.png')
    },
    ...
    [SkillEnum.DETERMINED]: {
        'icon': getImgUrl('skills/human/determined.png')
    },
    ...
    [SkillEnum.NURSE]: {
        'icon': getImgUrl('skills/human/nurse.png')
    },
