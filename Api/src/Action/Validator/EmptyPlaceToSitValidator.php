...
class EmptyPlaceToSitValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        ...
        if (!$constraint instanceof EmptyPlaceToSit) {
            throw new UnexpectedTypeException($constraint, EmptyPlaceToSit::class);
        }
        ...
        if ($bedsInRoom->filter($bedIsNotOccupied)->filter($bedIsNotBroken)->isEmpty() && $player->getPlace()->getName() !== RoomEnum::REFECTORY) {
