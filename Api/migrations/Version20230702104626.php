 ...
 */
final class Version20230702104626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipment_mechanic ADD collect_scrap_patrol_ship_damage TEXT DEFAULT NULL');
