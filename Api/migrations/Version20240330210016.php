 ...
 */
final class Version20240330210016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE moderationSanction (id INT NOT NULL, user_id INT DEFAULT NULL, moderation_action VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, message VARCHAR(255) DEFAULT NULL, is_visible_by_user BOOLEAN DEFAULT false NOT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
