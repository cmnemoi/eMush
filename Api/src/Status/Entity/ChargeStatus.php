...
class ChargeStatus extends Status implements GameVariableHolderInterface
{
    ...
    public function isChargedToMax(): bool
    {
        return $this->getCharge() === $this->getMaxChargeOrThrow();
    }
    ...
    public function getUsedCharge(string $actionName): ?self
    {
        if ($this->hasDischargeStrategy($actionName)) {
            return $this;
        }
