    ...
    <div class="char-panel" :class="player.character.key">
                ...
                <div class="health-points">
                    <div class="life">
                        <Tippy tag="ol">
                            ...
                            <li class="iconLife">
                                <p><img :src="getAssetUrl('lp.png')" alt="lp">{{ player.healthPoint.quantity }}</p>
                            </li>
                            <template #content>
                    ...
                    <div class="morale">
                        <Tippy tag="ol">
                            ...
                            <li class="iconMorale">
                                <p><img :src="getAssetUrl('moral.png')" alt="mp">{{ player.moralPoint.quantity }}</p>
                            </li>
                            <template #content>
        ...
        <div class="column">
            ...
            <div class="actions-sheet">
                <img :src="getAssetUrl('pam.png')" alt="pam">
                <Tippy tag="div">
                ...
                <ul class="specials">
                    <Tippy tag="li" v-if="player.shootPoint && player.shootPoint.quantity > 0">
                        <img :src="getAssetUrl('pa_shoot.png')">x{{ player.shootPoint.quantity }}
                        <template #content>
