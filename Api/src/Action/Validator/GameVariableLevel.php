 ...
 * @param string $checkMode    the criteria of the check (is_min, is_max, is_in_range, equals, not_equals)
 * @param int    $value        the value to compare the variable to, if using equals or not_equals checkMode
 */
