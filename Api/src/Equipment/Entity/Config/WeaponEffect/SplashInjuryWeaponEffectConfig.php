...
#[ORM\Entity]
class SplashInjuryWeaponEffectConfig extends AbstractEventConfig implements QuantityWeaponEffectConfig
{
    ...
    public function updateFromDto(SplashInjuryWeaponEffectConfigDto $dto): void
    {
        $this->name = $dto->name;
