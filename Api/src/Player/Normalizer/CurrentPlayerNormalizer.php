...
class CurrentPlayerNormalizer implements NormalizerInterface, NormalizerAwareInterface
{
    ...
    public function __construct(
        ...
        private PersonalNotesNormalizer $personalNotesNormalizer,
    ...
    public function normalize($object, ?string $format = null, array $context = []): array
    {
        ...
        $playerData = [
            ...
            'character' => [
                ...
                'humanSkillSlots' => $player->getHumanSkillSlots(),
                'mushSkillSlots' => $player->getMushSkillSlots(),
            ...
            'personalNotes' => $this->personalNotesNormalizer->normalize($player->getPersonalNotes(), $format, $context),
