...
#[ORM\Entity]
class MultiplyDamageOnMushTargetWeaponEffectConfig extends AbstractEventConfig implements QuantityWeaponEffectConfig
{
    ...
    public function updateFromDto(MultiplyDamageOnMushTargetWeaponEffectConfigDto $dto): void
    {
        $this->name = $dto->name;
