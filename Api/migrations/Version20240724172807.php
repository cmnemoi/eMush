 ...
 */
final class Version20240724172807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipment_mechanic ALTER skill SET DEFAULT \'\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE skill DROP CONSTRAINT FK_5E3DE47799E6F5DF');
        ...
        $this->addSql('ALTER TABLE equipment_mechanic ALTER skill DROP DEFAULT');
