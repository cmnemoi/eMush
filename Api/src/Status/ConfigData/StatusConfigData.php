...
abstract class StatusConfigData
{
    public static array $dataArray = [
        ...
        [
            'name' => PlayerStatusEnum::JOLT_COOLDOWN . '_default',
            'statusName' => PlayerStatusEnum::JOLT_COOLDOWN,
            'visibility' => VisibilityEnum::HIDDEN,
            'type' => 'charge_status_config',
            'chargeVisibility' => VisibilityEnum::HIDDEN,
            'chargeStrategy' => ChargeStrategyTypeEnum::DAILY_DECREMENT,
        ...
        [
            'name' => PlayerStatusEnum::BOARD_DISEASE_COOLDOWN . '_default',
            'statusName' => PlayerStatusEnum::BOARD_DISEASE_COOLDOWN,
            'visibility' => VisibilityEnum::HIDDEN,
            'type' => 'charge_status_config',
            'chargeVisibility' => VisibilityEnum::HIDDEN,
            'chargeStrategy' => ChargeStrategyTypeEnum::DAILY_DECREMENT,
        ...
        [
            'name' => PlayerStatusEnum::ELECTROCUTION_COOLDOWN . '_default',
            'statusName' => PlayerStatusEnum::ELECTROCUTION_COOLDOWN,
            'visibility' => VisibilityEnum::HIDDEN,
            'type' => 'charge_status_config',
            'chargeVisibility' => VisibilityEnum::HIDDEN,
            'chargeStrategy' => ChargeStrategyTypeEnum::DAILY_DECREMENT,
