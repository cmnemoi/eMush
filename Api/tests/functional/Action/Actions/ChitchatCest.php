...
final class ChitchatCest extends AbstractFunctionalTest
{
    ...
    private function thenIShouldSeeAPrivateLogForConfidentWithPlayerActions(FunctionalTester $I): void
    {
        $this->ISeeTranslatedRoomLogInRepository(
            expectedRoomLog: "**Chun** vous raconte ses dernières aventures et même si ça n'a pas l'air, on peut toujours apprendre quelque chose... Ses dernières actions sont **Fouiller** et **Fouiller**.",
    ...
    {
        $this->ISeeTranslatedRoomLogInRepository(
            expectedRoomLog: "**Chun** vous raconte ses dernières aventures et même si ça n'a pas l'air, on peut toujours apprendre quelque chose... Sa dernière action est **Fouiller**.",
            actualRoomLogDto: new RoomLogDto(
                player: $this->andie,
                log: LogEnum::CONFIDENT_ACTIONS,
                visibility: VisibilityEnum::PRIVATE,
