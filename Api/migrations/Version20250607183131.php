...
final class Version20250607183131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE daedalus_info ADD daedalus_projects_statistics_neron_projets_completed TEXT DEFAULT \'a:0:{}\' NOT NULL');
        $this->addSql('ALTER TABLE daedalus_info ADD daedalus_projects_statistics_research_projets_completed TEXT DEFAULT \'a:0:{}\' NOT NULL');
        $this->addSql('ALTER TABLE daedalus_info ADD daedalus_projects_statistics_pilgred_projets_completed TEXT DEFAULT \'a:0:{}\' NOT NULL');
