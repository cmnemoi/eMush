...
final class Version20230326173042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hunter_config (id INT NOT NULL, name VARCHAR(255) NOT NULL, hunter_name VARCHAR(255) NOT NULL, initial_health INT NOT NULL, initial_charge INT NOT NULL, initial_armor INT NOT NULL, min_damage INT NOT NULL, max_damage INT NOT NULL, hit_chance INT NOT NULL, dodge_chance INT NOT NULL, draw_cost INT NOT NULL, max_per_wave INT, draw_weight INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE hunter (id INT NOT NULL, hunter_config_id INT DEFAULT NULL, health INT NOT NULL, charge INT NOT NULL, armor INT NOT NULL, target VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
