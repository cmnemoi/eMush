 ...
 */
final class Version20201027194338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, game_config_id INT DEFAULT NULL, fruit_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_heavy TINYINT(1) NOT NULL, is_takeable TINYINT(1) NOT NULL, is_dropable TINYINT(1) NOT NULL, is_dismantable TINYINT(1) NOT NULL, is_stackable TINYINT(1) NOT NULL, is_hideable TINYINT(1) NOT NULL, is_fire_destroyable TINYINT(1) NOT NULL, is_fire_breakable TINYINT(1) NOT NULL, type VARCHAR(255) NOT NULL, max_maturation_time INT DEFAULT NULL, min_maturation_time INT DEFAULT NULL, min_oxygen INT DEFAULT NULL, max_oxygen INT DEFAULT NULL, min_action_point INT DEFAULT NULL, max_action_point INT DEFAULT NULL, min_movement_point INT DEFAULT NULL, max_movement_point INT DEFAULT NULL, min_health_point INT DEFAULT NULL, max_health_point INT DEFAULT NULL, min_moral_point VARCHAR(255) DEFAULT NULL, max_moral_point VARCHAR(255) DEFAULT NULL, satiety INT DEFAULT NULL, cures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', diseases LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_1F1B251EF67DC781 (game_config_id), INDEX IDX_1F1B251EBAC115F0 (fruit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE consumable_effect ADD CONSTRAINT FK_C27596264A5A89FC FOREIGN KEY (ration_id) REFERENCES item (id)');
        ...
        $this->addSql('ALTER TABLE plant_effect ADD CONSTRAINT FK_55F040791D935652 FOREIGN KEY (plant_id) REFERENCES item (id)');
