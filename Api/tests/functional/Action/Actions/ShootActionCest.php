...
final class ShootActionCest extends AbstractFunctionalTest
{
    ...
    private function weaponEventLogProvider(): array
    {
        return [
            ...
            WeaponEventEnum::BLASTER_SHOOTER_PLUS_1_DAMAGE_TARGET_DAMAGED_EARS->toString() => [WeaponEventEnum::BLASTER_SHOOTER_PLUS_1_DAMAGE_TARGET_DAMAGED_EARS->toString(), "Que résonne le hurlement des blasters, seuls les survivants en disserteront. **Chun** est bien placé pour tenter de le savoir. **Kuan Ti** y perd le sens de l'audition."],
