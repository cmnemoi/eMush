    ...
    <div class="box-container">
        <div class="paragraph">
            ...
            <div class="alphaLeeway">
                <span>
                    <img class="alpha" :src="getImgUrl('action_points/pa_core.png')">
        ...
        <div class="paragraph">
            ...
            <ul class="rulesList">
                ...
                <li class="rule"><img class="alpha" :src="getImgUrl('action_points/pa_core.png')"> <span v-html="$t('rules.communication.spokenLanguage')"></span></li>
            </ul>
        </div>
        ...
        <div class="alphaLeeway">
            <h2 class="subtitle"><img class="alpha" :src="getImgUrl('action_points/pa_core.png')"> {{ $t("rules.alphaRules.title") }}</h2>
