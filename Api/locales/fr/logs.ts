...
export default {
    [LogEnum.AWAKEN]: [
        {
            message:
                '**{character}** se réveille doucement de son long sommeil.',
            weighting: 1,
        },
    ],
    [LogEnum.NEW_DAY]: [
    ...
    [LogEnum.EAT]: [
        ...
        {
            message:
                "**{character}** s'est bien callé avec sa petite collation.",
            weighting: 2500,
        },
        {
    ...
    [LogEnum.TAKE]: [
        {
            message: '**{character}** a pris un **{item}**.',
            weighting: 1,
        },
    ],
    [LogEnum.DROP]: [
        {
            message: '**{character}** a lâché un **{item}**.',
            weighting: 1,
        },
    ],
};
