...
<tileset version="1.5" tiledversion="1.7.2" name="engine_room2" tilewidth="350" tileheight="188" tilecount="8" columns="1" objectalignment="bottomleft">
 <image source="../engine_room2.png" width="350" height="1504"/>
 <tile id="0">
  <animation>
