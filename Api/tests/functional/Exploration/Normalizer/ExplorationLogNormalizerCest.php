    ...
    public function testNormalizeKillAllEvent(FunctionalTester $I): void
    {
        ...
        $I->assertEquals(
            expected: [
                ...
                'eventDescription' => 'Alors que la montagne la plus proche de l\'expédition se met à cracher un jet de lave à plus de 500 m de hauteur, le sol s\'effondre sous leurs pieds et les engloutit dans un déluge de flammes.',
    ...
    public function testNormalizeFightEventWithAWhiteFlag(FunctionalTester $I): void
    {
        ...
        $I->assertEquals(
            expected: [
                ...
                'planetSectorKey' => PlanetSectorEnum::INTELLIGENT,
                'planetSectorName' => 'Vie intelligente',
                'eventName' => 'Nouveau secteur',
                'eventDescription' => 'Après une série de signes de main maladroits, la créature finit par inscrire quelque chose sur votre carte. Un petit détour semble de rigueur.',
                'eventOutcome' => 'Nouveau secteur ajouté sur la planète.',
            ],
            actual: $normalizedExplorationLog,
        );
    ...
    public function testNormalizeStarmapEvent(FunctionalTester $I): void
    {
        ...
        $I->assertEquals(
            expected: [
                ...
                'planetSectorName' => 'Cristallite',
                'eventName' => 'Éclat de carte',
                'eventDescription' => 'Ce champ de cristallite est en activité. Au centre de l\'atrium principal, un éclat baignant dans des eaux métalliques fait converger des faisceaux de lumières aux couleurs inconnues. Allez hop, on l\'embarque.',
                'eventOutcome' => 'Vous trouvez 1 éclat de carte stellaire en cristallite.',
            ],
            actual: $normalizedExplorationLog,
        );
    }
