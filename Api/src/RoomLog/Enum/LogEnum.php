...
abstract class LogEnum
{
    ...
    public const string DRONE_TAKEOFF = 'drone_takeoff';
    ...
    public const array MODIFIER_LOG_ENUM = [
        self::VISIBILITY => [
            ...
            SymptomEnum::PSYCHOTIC_ATTACKS => VisibilityEnum::HIDDEN,
        ...
        self::VALUE => [
            ...
            SymptomEnum::PSYCHOTIC_ATTACKS => SymptomEnum::PSYCHOTIC_ATTACKS,
