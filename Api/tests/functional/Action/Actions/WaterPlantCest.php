 ...
 * @internal
 */
final class WaterPlantCest extends AbstractFunctionalTest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->waterPlant = $I->grabService(WaterPlant::class);
    ...
    public function botanistShouldNotConsumeActionPoints(FunctionalTester $I)
    {
        ...
        $this->givenPlayerHasThirstyPlant();

        $this->givenPlayerHasTenActionPoints($I);

        $this->whenPlayerWatersPlant();
