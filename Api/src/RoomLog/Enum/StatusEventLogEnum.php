...
abstract class StatusEventLogEnum
{
    ...
    public const array CHARGE_STATUS_UPDATED_LOGS = [
        self::GAIN => [
            self::VALUE => [
                SkillPointsEnum::GARDEN_POINTS->value => self::GAIN_BOTANIST_POINT,
                SkillPointsEnum::CORE_POINTS->value => self::GAIN_CONCEPTOR_POINT,
                SkillPointsEnum::COMPUTER_POINTS->value => self::GAIN_IT_EXPERT_POINT,
                SkillPointsEnum::HEAL_POINTS->value => self::GAIN_NURSE_POINT,
            ...
            self::VISIBILITY => [
                ...
                SkillPointsEnum::CORE_POINTS->value => VisibilityEnum::PRIVATE,
                SkillPointsEnum::COMPUTER_POINTS->value => VisibilityEnum::PRIVATE,
                SkillPointsEnum::HEAL_POINTS->value => VisibilityEnum::PRIVATE,
