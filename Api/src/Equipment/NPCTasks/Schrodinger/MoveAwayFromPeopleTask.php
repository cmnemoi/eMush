...
class MoveAwayFromPeopleTask extends AbstractCatTask
{
    ...
    {
        return $this->findNextRoomTowardsCondition->execute($NPC->getPlace(), static fn (Place $room) => $room->getNumberOfPlayersAlive() === 0);
    }
