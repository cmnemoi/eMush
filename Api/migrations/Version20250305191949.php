 ...
 */
final class Version20250305191949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE unique_items (id INT NOT NULL, unique_item_names TEXT DEFAULT \'a:0:{}\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN unique_items.unique_item_names IS \'(DC2Type:array)\'');
