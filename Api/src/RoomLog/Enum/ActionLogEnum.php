...
abstract class ActionLogEnum
{
    ...
    public const string SHOOT_EQUIPMENT_SUCCESS = 'shoot_equipment_success';
    public const string SHOOT_EQUIPMENT_FAIL = 'shoot_equipment_fail';
    ...
    public const string CURE_SUCCESS = 'cure_success';
    ...
    public const array ACTION_LOGS = [
        ...
        ActionEnum::SLIME_OBJECT->value => [
            ActionOutputEnum::SUCCESS => self::SLIME_OBJECT_SUCCESS,
        ],
        ...
        ActionEnum::SHOOT_EQUIPMENT->value => [
            ActionOutputEnum::SUCCESS => self::SHOOT_EQUIPMENT_SUCCESS,
            ActionOutputEnum::FAIL => self::SHOOT_EQUIPMENT_FAIL,
        ],
        ...
        ActionEnum::FEED_THE_PET->value => [
            ActionOutputEnum::SUCCESS => ActionEnum::FEED_THE_PET->value . '_success',
        ],
        ActionEnum::CURE->value => [
            ActionOutputEnum::SUCCESS => self::CURE_SUCCESS,
        ],
    ];
