...
abstract class ModifierNameEnum
{
    ...
    public const string MUSH_CONSUME_SATIETY_OLD_RULE = 'mush_consume_satiety_old_rule';
    ...
    public const string ERIDIANI_PLUS_2_MAX_PRIVATE_CHANNELS = 'rebel_plus_2_max_private_channels';
    ...
    public const string PLUS_1_ACTION_POINTS_ON_EXTRACT_SPORE = 'plus_1_action_points_on_extract_spore';
