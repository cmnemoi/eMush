...
class DoorEnum
{
    ...
    public const FRONT_CORRIDOR_MEDLAB = 'frot_corridor_medlab';
    ...
    public const ALPHA_BAY_CENTRAL_CORRIDOR = 'alpnha_bay_central_corridor';
    ...
    public const REAR_CORRIDOR_ALPHA_DORM = 'rear_corrdior_alpha_dorm';
    public const REAR_CORRIDOR_BRAVO_DORM = 'rear_corrdior_bravo_dorm';
    public const REAR_CORRIDOR_BAY_ALPHA_2 = 'rear_corrdior_bay_alpha_2';
    public const REAR_CORRIDOR_NEXUS = 'rear_corrdior_nexus';
    public const REAR_CORRIDOR_BAY_ICARUS = 'rear_corrdior_bay_icarus';
    public const REAR_CORRIDOR_REAR_ALPHA_STORAGE = 'rear_corrdior_rear_alpha_storage';
    public const REAR_CORRIDOR_REAR_BRAVO_STORAGE = 'rear_corrdior_rear_bravo_storage';
