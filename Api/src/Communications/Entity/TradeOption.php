...
class TradeOption
{
    ...
    public function __construct(array $requiredAssets, array $offeredAssets, SkillEnum $requiredSkill = SkillEnum::NULL, string $name = '')
    {
        $this->name = $name;
    ...
    {
        return $this->requiredSkill !== SkillEnum::NULL;
    }
