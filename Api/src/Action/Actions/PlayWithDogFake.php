...
class PlayWithDogFake extends AbstractAction
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata): void
    {
        ...
        $metadata->addConstraint(new NumberOfAttackingHunters(['mode' => NumberOfAttackingHunters::GREATER_THAN, 'number' => 0, 'exclude' => HunterEnum::getHuntersThatDoNotStopFromAcceptingTrade()->toArray(), 'groups' => ['execute'], 'message' => ActionImpossibleCauseEnum::DOG_IS_WORRIED]));
