 ...
 */
final class Version20230226070923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abstract_modifier_config ADD apply_on_target BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE abstract_modifier_config ADD tag_constraints TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE abstract_modifier_config ADD revert_on_remove BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE abstract_modifier_config DROP apply_on_action_parameter');
        ...
        $this->addSql('COMMENT ON COLUMN abstract_modifier_config.tag_constraints IS \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abstract_modifier_config ADD apply_on_action_parameter BOOLEAN NOT NULL');
        ...
        $this->addSql('ALTER TABLE abstract_modifier_config DROP apply_on_target');
        $this->addSql('ALTER TABLE abstract_modifier_config DROP tag_constraints');
