 ...
 */
final class Version20230401171836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hunter (id INT NOT NULL, hunter_config_id INT DEFAULT NULL, space_id INT DEFAULT NULL, hunter_variables_id INT DEFAULT NULL, target VARCHAR(255) NOT NULL, in_pool BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4AD78C65324BCEC3 ON hunter (hunter_config_id)');
        $this->addSql('CREATE INDEX IDX_4AD78C6523575340 ON hunter (space_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4AD78C656E3453A8 ON hunter (hunter_variables_id)');
        $this->addSql('CREATE TABLE hunter_config (id INT NOT NULL, name VARCHAR(255) NOT NULL, hunter_name VARCHAR(255) NOT NULL, initial_health INT NOT NULL, damage_range TEXT NOT NULL, hit_chance INT NOT NULL, dodge_chance INT NOT NULL, draw_cost INT NOT NULL, max_per_wave INT DEFAULT NULL, draw_weight INT NOT NULL, spawn_difficulty INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE hunter ADD CONSTRAINT FK_4AD78C6523575340 FOREIGN KEY (space_id) REFERENCES room (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hunter DROP CONSTRAINT FK_4AD78C6523575340');
