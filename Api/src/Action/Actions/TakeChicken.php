...
/**
 * Class implementing a unique "Take" action (picking up the Space Chicken).
 * This action is granted by the Space Chicken.
 *
 * This bird is wild and comes with a heightened chance to hurt the player,
 * hence the need for a custom Take action.
 */
class TakeChicken extends AbstractAction
{
    protected ActionEnum $name = ActionEnum::TAKE_CHICKEN;
