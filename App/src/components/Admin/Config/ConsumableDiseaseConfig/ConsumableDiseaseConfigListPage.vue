    ...
    <div class="user_list_container">
        ...
        >
            ...
            <template #row-actions="slotProps">
                <router-link :to="{ name: 'AdminConsumableDiseaseConfigDetail', params: { consumableDiseaseConfigId : slotProps.id } }">{{ $t('admin.edit') }}</router-link>
            </template>
        </Datatable>
    </div>
</template>
...
export default defineComponent({
    name: "ConsumableDiseaseConfigListPage",
    components: {
        Datatable
    },
    data() {
    ...
    methods: {
        loadData() {
            ...
            ApiService.get(urlJoin(import.meta.env.VITE_APP_API_URL+'consumable_disease_configs'), params)
                .then((result) => {
                    return result.data;
                })
