...
class FireTest extends TestCase
{
    ...
    public function testNewCycleFireDamage()
    {
        ...
        $this->eventDispatcher
            ...
            ->withArgs(fn (PlayerModifierEventInterface $playerEvent, string $eventName) => (
                intval($playerEvent->getQuantity()) === -2 && $eventName === PlayerModifierEventInterface::HEALTH_POINT_MODIFIER
            ))
            ->once()
        ;
