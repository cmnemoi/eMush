...
class PlayerSubscriber implements EventSubscriberInterface
{
    ...
    public function onConversionPlayer(PlayerEvent $playerEvent): void
    {
        ...
        $mushStatus = $this->statusService->createStatusFromConfig($mushStatusConfig, $player, $playerEvent->getReasons()[0], $playerEvent->getTime());
    ...
    {
        $this->statusService->removeAllStatuses($playerEvent->getPlayer(), $playerEvent->getReasons()[0], $playerEvent->getTime());
    }
}
