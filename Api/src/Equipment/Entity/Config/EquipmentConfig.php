...
class EquipmentConfig
{
    ...
    /**
     * @psalm-param array<int, EquipmentMechanic>|ArrayCollection<int<0,max>, EquipmentMechanic> $mechanics
     */
    ...
    /**
     * @psalm-param ArrayCollection<int<0,max>, StatusConfig>| array<int, StatusConfig> $initStatuses
     */
