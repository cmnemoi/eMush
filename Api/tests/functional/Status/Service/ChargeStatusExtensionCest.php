 ...
 * @internal
 */
final class ChargeStatusExtensionCest extends AbstractFunctionalTest
{
    ...
    {
        $this->deletePlayerSkillService->execute(SkillEnum::IT_EXPERT, $this->kuanTi);
    }

    private function whenKuanTiHasPolymathRemoved(): void
    {
        $this->deletePlayerSkillService->execute(SkillEnum::POLYMATH, $this->kuanTi);
    }
