...
final class GoBerserkCest extends AbstractFunctionalTest
{
    ...
    public function shouldPrintAPublicLog(FunctionalTester $I): void
    {
        ...
        $this->ISeeTranslatedRoomLogInRepository(
            expectedRoomLog: ":mush: **Kuan Ti** se recroqueville. Il semble souffrir, ses cris résonnent, il vomit une bile immonde qui fait fondre ses vêtements... Quelle horreur\u{a0}! Il a complètement changé de forme\u{a0}!",
