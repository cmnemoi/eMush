...
abstract class EquipmentMechanic
{
    ...
    public function getActionByNameOrThrow(string $name): ActionConfig
    {
        $action = $this->actions->filter(static fn (ActionConfig $action) => $action->getName() === $name)->first() ?: null;
