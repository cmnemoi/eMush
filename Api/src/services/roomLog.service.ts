...
export default class RoomLogService {
    ...
    public static async createLog(
        ...
        const logsMessages = await import("../../locales/" + GameConfig.language + "/logs");
    ...
    private static async loadParameters(parameters: MessageParameters): Promise<MessageParameters> {
        if (typeof parameters.character !== "undefined" && parameters.character !== null) {
            const character = await import("../../locales/" + GameConfig.language + "/character");
