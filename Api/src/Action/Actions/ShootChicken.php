...
/**
 * Special implementation of the Shoot action that targets equipments instead of players,
 * for the purpose of shooting at the Space Chicken.
 */
class ShootChicken extends AttemptAction
{
    protected ActionEnum $name = ActionEnum::SHOOT_CHICKEN;
    ...
    private function killChicken(): void
    {
        $chicken = $this->gameItemTarget();
        ...
        if ($chicken->hasStatus(EquipmentStatusEnum::CHICKEN_INFECTED)) {
            $interactEvent->addTag(EquipmentStatusEnum::CHICKEN_INFECTED);
        }
