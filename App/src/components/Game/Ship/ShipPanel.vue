    ...
    <div v-if="!loading" class="ship-view">
      <div class="textual">
        <div class="gm4html5_div_class" id="gm4html5_div_id">
          ...
          <canvas id="canvas" width="832" height="896">
...
export default {
  ...
  computed: {
    ...mapGetters("player", ["getPlayer", "loading"])
  },
  mounted() {
    let gameLogic = document.createElement("script");
    gameLogic.setAttribute("src", "html5game/eMush.js?FDEBC=22254700");
  ...
  methods: {
    ...
    ...mapActions("player", ["reloadPlayer", "selectTarget", "setLoading"])
  }
};
</script>
...
.ship-panel {
  ...
  width: 424px;
  height: 460px;
  background: #09092d url("~@/assets/images/shipview/background.png") center
    repeat;
    ...
    & .crew-position {
      ...
      li {
        ...
        @for $i from 1 through 16 {
          // randomize crew position, for testing only
          &:nth-child(#{$i}) {
