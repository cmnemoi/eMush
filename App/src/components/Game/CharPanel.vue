      ...
      & .life, & .morale {
        ...
        & ul {
          ...
          & li {
            ...
            box-shadow: 1px 1px 0 0 inset rgba(255,255,255,.7);

            &.empty {
              background: rgba(37,72,137,1);
              box-shadow: 1px 1px 0 0 inset rgba(78,154,255,.7);
            }
          }
        }
      }
        ...
        & > div {
          ...
          & ul {
            ...
            & li {
              ...
              background: rgba(138,170,44,1);
              box-shadow: 0 -1px 0 0 inset rgba(0,0,0,.4);
            }
          }
        }
